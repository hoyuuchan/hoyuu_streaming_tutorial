const images = [
  ...
  { src: './image/감정표현/창섭댄스.gif', tag: '~창섭댄스', category: '감정표현', update: true },
  ...
  { src: './image/기타/도로롱하트.gif', tag: '~도로롱하트', category: ['게임기타', '감정표현'] },
  ...
  { src: './image/기타/테토뚱뚱.webp', tag: '~테토뚱뚱', category: '기타' },
  ...
  { src: './image/기타/스피키.jpg', tag: '~스피키', category: ['게임기타', '감정표현'] },
  ...
  { src: './image/오리지널/호유다인2.png', tag: '~호유다인2', category: ['호유링기링', '디맥'], update: true },
  ...
  { src: './image/오리지널/호유엠마.png', tag: '~호유엠마', category: '호유링기링', update: true },
  { src: './image/오리지널/호유슈가.png', tag: '~호유슈가', category: ['호유링기링', '게임기타'], update: true },
