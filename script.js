const images = [
  ...
  { src: './image/감정표현/돌림판.gif', tag: '~돌림판', category: '감정표현', update: true },
  { src: './image/감정표현/돌림판2.gif', tag: '~돌림판2', category: '감정표현', update: true },
  { src: './image/감정표현/주작.png', tag: '~주작', category: '감정표현', update: true },
  { src: './image/감정표현/주작2.gif', tag: '~주작2', category: '감정표현', update: true },
  ...
  { src: './image/기타/도로롱레몬.png', tag: '~도로롱레몬', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/도로롱레몬2.png', tag: '~도로롱레몬2', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/도로롱생각.webp', tag: '~도로롱생각', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/도로롱감전.webp', tag: '~도로롱감전', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/도로롱관찰.webp', tag: '~도로롱관찰', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/도로롱기타.webp', tag: '~도로롱기타', category: ['게임기타', '감정표현'], update: true },
  ...
  { src: './image/오리지널/호피키.png', tag: '~호피키', category: '란호유', update: true },
  { src: './image/오리지널/호피키.gif', tag: '~호피키으앙', category: '란호유', update: true },
