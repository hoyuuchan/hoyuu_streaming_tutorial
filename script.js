const images = [
  ...
  // 감정표현
  { src: './image/감정표현/마참내.png', tag: '~마참내', category: ['감정표현', '기쁨'] },
  { src: './image/감정표현/두렵다.png', tag: '~두렵다', category: '감정표현' },
  { src: './image/감정표현/띠껍다.png', tag: '~띠껍다', category: '감정표현' },
  { src: './image/감정표현/멋있다.png', tag: '~멋있다', category: ['감정표현', '기쁨'] },
  { src: './image/감정표현/슬프다.png', tag: '~슬프다', category: ['감정표현', '슬픔'] },
  { src: './image/감정표현/이상하다.png', tag: '~이상하다', category: ['감정표현', '의문'] },
  { src: './image/감정표현/즐겁다.png', tag: '~즐겁다', category: ['감정표현', '기쁨'] },
  { src: './image/감정표현/화난다.png', tag: '~화난다', category: ['감정표현', '화남'] },
  ...
  { src: './image/감정표현/사랑해요.png', tag: '~사랑해요', category: '감정표현' },
  ...
  { src: './image/마크/소ㅠㅠ.png', tag: '~소ㅠㅠ', category: ['마크', '슬픔'] },
