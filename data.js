const images = [
  ...
  { src: './image/감정표현/창섭댄스2.gif', tag: '~창섭댄스2', category: '감정표현', update: true },
  ...
  { src: './image/기타/켈시눈치.png', tag: '~켈시눈치', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/켈시답변.png', tag: '~켈시답변', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/켈시아직.png', tag: '~켈시아직', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/켈시알필요.png', tag: '~켈시알필요', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/켈시정신.png', tag: '~켈시정신', category: ['게임기타', '감정표현'], update: true },
  ...
  { src: './image/오리지널/호유우루슈.png', tag: '~호유우루슈', category: '호유링기링', update: true },
