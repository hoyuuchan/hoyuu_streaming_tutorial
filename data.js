const images = [
  ...
  { src: './image/기타/도로롱탕.gif', tag: '~도로롱탕', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/도로롱탕탕.gif', tag: '~도로롱탕탕', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/도로롱타라.jpg', tag: '~도로롱타라', category: ['게임기타', '감정표현'], update: true },
  ...
  { src: './image/오리지널/호유프라나.png', tag: '~호유프라나', category: ['호유링기링', '게임기타'], update: true },
