const images = [
  ...
  { src: './image/기타/버터나락.gif', tag: '~버터나락', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/버터나락2.gif', tag: '~버터나락2', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/버터붕권.gif', tag: '~버터붕권', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/버터붕권2.gif', tag: '~버터붕권2', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/버터아쿠마.gif', tag: '~버터아쿠마', category: ['게임기타', '감정표현'], update: true },
  { src: './image/기타/버터아쿠마2.gif', tag: '~버터아쿠마2', category: ['게임기타', '감정표현'], update: true },
  ...
  { src: './image/오리지널/호유멘헤라.png', tag: '~호유멘헤라', category: ['란호유', '호유링기링'], update: true },
