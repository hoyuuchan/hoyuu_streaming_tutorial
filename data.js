const images = [
  ...
  { src: './image/감정표현/그건니가.png', tag: '~그건니가', category: '감정표현', update: true },
  ...
  { src: './image/오리지널/호유깡깡.png', tag: '~호유구깡깡', category: ['호유링기링', '게임기타'], update: true },
  { src: './image/오리지널/호유우나.png', tag: '~호유우나', category: ['호유링기링'], update: true },
