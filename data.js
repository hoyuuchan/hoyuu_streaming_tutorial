const images = [
  ...
  { src: './image/기타/레니귀엽잔아.png', tag: '~난귀엽잔아', category: '기타', update: true },
  { src: './image/기타/레니더어린거.png', tag: '~더어린거', category: '기타', update: true },
  { src: './image/기타/레니어린거더.png', tag: '~어린거더', category: '기타', update: true },
  { src: './image/기타/레니뭐레니.jpg', tag: '~뭐레니', category: '기타', update: true },
  { src: './image/기타/레니썩었잔아.png', tag: '~썩었잔아', category: '기타', update: true },
  { src: './image/기타/레니지금바로.png', tag: '~지금바로시작해', category: '기타', update: true },
  { src: './image/기타/레니휴지.png', tag: '~레니휴지', category: '기타', update: true },
  { src: './image/기타/선도워킹.gif', tag: '~선도워킹', category: '기타' },

  // 오리지널
  { src: './image/오리지널/란호유.png', tag: '~란호유', category: '란호유' },
  { src: './image/오리지널/호유핑크.png', tag: '~핑크호유', category: '란호유', update: true },
  ...
  { src: './image/오리지널/호유피어.png', tag: '~호유피어', category: '란호유', update: true },
  ...
  { src: './image/오리지널/호유갸루이상해씨.png', tag: '~호유갸루이상해씨', category: ['호유링기링'], update: true },
