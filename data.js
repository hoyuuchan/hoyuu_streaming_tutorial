const images = [
  ...
  { src: './image/기타/도로롱찰싹.gif', tag: '~도로롱찰싹', category: ['게임기타', '감정표현'], update: true },
  ...
  { src: './image/오리지널/호유로시.png', tag: '~호유로시', category: ['호유링기링', '게임기타'], update: true },
  ...
  { src: './image/오리지널/호유내려쳐요.png', tag: '~호유내려쳐요', category: '란호유', update: true },
